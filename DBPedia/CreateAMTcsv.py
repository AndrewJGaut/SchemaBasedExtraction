...
def createCSV_fromtonyfile(dataset_path, csv_path):
    # get set of names
...
def createCSV_fromtonyfile2(dataset_path, csv_path):
    # get set of names
    tsun_dataset = xlrd.open_workbook(dataset_path)
    males = tsun_dataset.sheet_by_index(0)
    females = tsun_dataset.sheet_by_index(1)
...
def convertToBatches(amt_data_path, amt_splits_path, out_path):
    ...
    out_dataset.save("amt_data/FINAL PILOT SPLITS.xls")
...
if __name__ == '__main__':
    ...
    #convertToBatches('amt_data/pilot_study.xls', 'amt_data/AMT_split.xls', '')