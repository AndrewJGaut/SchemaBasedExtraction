...
parser.add_argument('--encoder', nargs='?', default='cnn')
parser.add_argument('--selector', nargs='?', default='att')
parser.add_argument('--test_file_name', nargs='?', default='test_female.json')
...
train_loader = nrekit.data_loader.json_file_data_loader(os.path.join(dataset_dir, 'train.json'),
                                                        ...
                                                        shuffle=True)
test_loader = nrekit.data_loader.json_file_data_loader(os.path.join(dataset_dir, args.test_file_name),
                                                       os.path.join(dataset_dir, 'word_vec.json'),
                                                       os.path.join(dataset_dir, 'rel2id.json'),
...
auc, pred_result = framework.test(model,
